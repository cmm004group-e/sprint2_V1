...
<div class="container-fluid">
	...
	<body>
            <section class="main-container">
                <h2>Sign in</h2>
                <form class="signup-form" method="GET" action="app/users/signin.php">
                    <input type="text" name="username" required="required" placeholder="Username/E-mail">
                    <input type="password" name="password" required="required" maxlength="20" placeholder="Password">
